                    ...
                    <div class="row text-dark">
                      ...
                      <div class="col-sm-9">
                        <div class="filter-group">
                          <label className="col-4 fs-5 text fw-bold ">رقم الطاولة</label>
                    ...
                    <form onSubmit={createTable}>
                      ...
                      <div className="modal-body">
                        <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6  ">
                          <label className="col-4 fs-5 text fw-bold ">رقم السكشن</label>
                        ...
                        <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6  ">
                          <label className="col-4 fs-5 text fw-bold ">عدد المقاعد</label>
                ...
                <div className="modal-dialog">
                  <div className="modal-content">
                    <form onSubmit={createQR}>
                      ...
                      <div className="modal-body">
                        <div ref={printtableqr} style={{ width: "100%", maxWidth: '400px', height: "100%", display: 'flex', alignItems: 'center', justifyContent: 'center' }} className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6  ">
