                    ...
                    <div class="row text-dark">
                      ...
                      <div class="col-sm-9">
                        ...
                        <div class="filter-group">
                          <label className="col-4 fs-5 text-nowrap fw-bold ">اسم المورد</label>
                      ...
                      <div className="modal-body">
                        ...
                        {phone && phone.map((phoneNumber, index) => (
                          <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6 " key={index}>
                            <label className="col-4 fs-5 text-nowrap fw-bold ">الموبايل {index + 1}</label>
                        ...
                        <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6 ">
                          <label className="col-4 fs-5 text-nowrap fw-bold ">الواتس اب</label>
                        ...
                        <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6 ">
                          <label className="col-4 fs-5 text-nowrap fw-bold ">نوع الدفع</label>
                        ...
                        {itemsSupplied.map((item, index) => (
                          <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6 " key={index}>
                            <label className="col-4 fs-5 text-nowrap fw-bold ">العنصر المورد {index + 1}</label>
                        ...
                        <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6 ">
                          <label className="col-4 fs-5 text-nowrap fw-bold ">الرصيد الافتتاحي</label>
                          <input type="number" className="form-control" onChange={(e) => setCurrentBalance(e.target.value)} />
                        </div>
                        {financialInfo.map((info, index) => (
                          <div className="form-group w-100 h-auto px-3 d-flex align-itmes-center justify-content-start col-12  col-md-6 " key={index}>
                            <label className="col-4 fs-5 text-nowrap fw-bold ">المعلومات المالية {index + 1}</label>
