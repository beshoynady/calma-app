          ...
          <div className="table-title">
            <div className="row">
              ...
              <div className="col-sm-6 d-flex justify-content-end">
                <a href="#addPurchaseInvoiceModal" className="btn w-50 btn-success" data-toggle="modal"><i className="material-icons">&#xE147;</i> <label className="col-4 fs-5 text-nowrap fw-bold ">اضافه فاتورة جديدة</label></a>
                <a href="#deleteStockactionModal" className="btn w-50 btn-danger" data-toggle="modal"><i className="material-icons">&#xE15C;</i> <label className="col-4 fs-5 text-nowrap fw-bold ">حذف</label></a>
              </div>
            </div>
          </div>
          <div className="table-filter print-hide">
            <div class="row text-dark d-flex -flex-wrap align-items-center justify-content-start">
              <div className="show-entries">
                <label className="col-4 fs-5 text-nowrap fw-bold ">عرض</label>
                ...
                <label className="col-4 fs-5 text-nowrap fw-bold ">صفوف</label>
              </div>
