              ...
              <div className="modal-body p-4 text-right">
                <div className="row">
                  <div className="form-group col-12 col-md-6">
                    <label className="col-4 fs-4 text-wrap text-right fw-bolder ">تاريخ الحالي</label>
                    <input
                      type="text"
                  ...
                  <div className="form-group col-12 col-md-6">
                    <label className="col-4 fs-4 text-wrap text-right fw-bolder ">تاريخ الوصول</label>
                    <input
                      type="datetime-local"
                      className="form-control border-primary"
                      name="arrivalDate"
                  ...
                  <div className="form-group col-12 col-md-6">
                    <label className="col-4 fs-4 text-wrap text-right fw-bolder ">دقائق التأخر</label>
                    <input
                      type="text"
                      className="form-control border-primary"
                      name="lateMinutes"
            ...
            <form onSubmit={recordDeparture}>
              ...
              <div className="modal-body p-4 text-right">
                <div className="row">
                  ...
                  <div className="form-group col-12 col-md-6">
                    <label className="col-4 fs-4 text-wrap text-right fw-bolder ">تاريخ الانصراف</label>
                    <input
                      type="datetime-local"
                      className="form-control border-primary"
                      name="departureDate"
                  ...
                  <div className="form-group col-12 col-md-6">
                    <label className="col-4 fs-4 text-wrap text-right fw-bolder ">دقائق التجاوز</label>
                    <input
                      type="text"
                      className="form-control border-primary"
