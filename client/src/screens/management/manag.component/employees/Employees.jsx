...
const Employees = () => {
  ...
  const createEmployee = async (e) => {
    ...
    try {
      const newemployee = await axios.post('https://calma-api-puce.vercel.app/api/employee', { fullname, basicSalary, numberID, username, password, address, phone, email, isActive, role, sectionNumber })
  ...
  const editEmployee = async (e) => {
    ...
    try {
      ...
      const update = await axios.put(`https://calma-api-puce.vercel.app/api/employee/${employeeid}`, updateData);
  ...
  const deleteEmployee = async (e) => {
    e.preventDefault();
    try {
      const deleted = await axios.delete(`https://calma-api-puce.vercel.app/api/employee/${employeeid}`);
