    ...
    return (
        <detacontext.Consumer>
            {({ employeeLoginInfo, employeelogout }) => (
                ...
                <nav className="navbar w-100 navbar-expand-lg navbar-light bg-light" style={{ height: '60px' }}>
                    ...
                    <div className="navbar-nav ms-auto">
                        <div className="nav-item d-flex align-items-center">
                            ...
                            <span className="ms-2">{userJob}</span>
                        </div>
                        <div className="nav-item dropdown">
                            ...
                            {showMessages && (
                                <div className="dropdown-menu dropdown-menu-right show" aria-labelledby="messagesDropdown">
                        ...
                        <div className="nav-item dropdown">
                            ...
                            {showNotifications && (
                                <div className="dropdown-menu dropdown-menu-right show" aria-labelledby="notificationsDropdown">
